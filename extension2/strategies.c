...
strategy strategies[NUM_STRATEGIES] = {basic, basic_plus, genetic_algorithm, genetic_algorithm};
char* strategy_names[NUM_STRATEGIES] = {"Basic", "Basic Plus", "Genetic Algorithm Avg", "Genetic Algorithm Max"};
